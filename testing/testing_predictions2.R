...
fpros_qb <- read_csv(eval(paste("~/R Stuff/FantasyFootball/Online_Models/Week_", week, "/FantasyPros_", This_Year, "_Week_", week, "_QB_Rankings.csv", sep = "")))
fpros_rb <- read_csv(eval(paste("~/R Stuff/FantasyFootball/Online_Models/Week_", week, "/FantasyPros_", This_Year, "_Week_", week, "_RB_Rankings.csv", sep = "")))
fpros_wr <- read_csv(eval(paste("~/R Stuff/FantasyFootball/Online_Models/Week_", week, "/FantasyPros_", This_Year, "_Week_", week, "_WR_Rankings.csv", sep = "")))
fpros_te <- read_csv(eval(paste("~/R Stuff/FantasyFootball/Online_Models/Week_", week, "/FantasyPros_", This_Year, "_Week_", week, "_TE_Rankings.csv", sep = "")))
