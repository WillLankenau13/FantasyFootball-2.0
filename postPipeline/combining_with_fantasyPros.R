...
#My Projections
player_predictions <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/weeklyData/weeklyPredictions/", This_Year, "/Week_", upcoming_week, "_Player_Predictions.csv", sep = "")))
...
#Write
write_csv(n_combined, (eval(paste("~/R Stuff/FantasyFootball 2.0/predictionsLibrary/combinedWeeklyPredictions/", This_Year, "/Week_", upcoming_week, ".csv", sep = ""))))
