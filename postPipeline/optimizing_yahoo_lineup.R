...
optim_wo <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/predictionsLibrary/combinedWeeklyPredictions/", This_Year, "/Week_", upcoming_week, "_With_Betting_Odds.csv", sep = "")))
