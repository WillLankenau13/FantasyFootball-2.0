...
###read files
d_player_percents_past_year <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/weeklyData/weeklyRatings/", Past_Year, "/Week_19/Player_Percents.csv", sep = "")))
draft <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/preseason/draft/draft_", This_Year, ".csv", sep = ""))) %>% 
  clean_names() %>% 
  rename("team" = "tm") %>% 
  select(player, team, pos, pick)
starting_QBs <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/weeklyData/startingQBs/Starting_QBs_", This_Year, ".csv", sep = "")))
qb_ratings <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/weeklyData/weeklyRatings/", Past_Year, "/Week_19/QB_Ratings.csv", sep = "")))
d_off_team_ratings <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/weeklyData/weeklyRatings/", Past_Year, "/Week_19/Off_Team_Ratings.csv", sep = "")))
d_def_team_ratings <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/weeklyData/weeklyRatings/", Past_Year, "/Week_19/Def_Team_Ratings.csv", sep = "")))


#depth chart
if(This_Year >= 2025){
  d_depth_chart <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/preseason/depthCharts/", This_Year, "/Week_1_Depth_Chart.csv", sep = "")))
...
#Yahoo Week 1
Yahoo_Week_1 <- read_csv(eval(paste("~/R Stuff/FantasyFootball 2.0/weeklyData/Yahoo/", This_Year, "/Yahoo_Week_1.csv", sep = ""))) %>% 
  select(ID:Starting) %>% 
...
####Write Csv####
write_csv(adj_player_percents, eval(paste("~/R Stuff/FantasyFootball 2.0/preseason/ratings/", This_Year, "/Player_Percents.csv", sep = "")))
write_csv(qb_ratings, eval(paste("~/R Stuff/FantasyFootball 2.0/preseason/ratings/", This_Year, "/QB_Ratings.csv", sep = "")))
